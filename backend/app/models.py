...
class Route(Base):
    ...
    depart_code: Mapped[Optional[str]] = mapped_column(String(10), nullable=True, index=True)
    arrivee_code: Mapped[Optional[str]] = mapped_column(String(10), nullable=True, index=True)
